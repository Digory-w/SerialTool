...
#include <memory>
#include "src/settings/settingswidget.h"
...
QT_MOC_LITERAL(1, 15, 12), // "mutexWidgets"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 5), // "mutex"
QT_MOC_LITERAL(4, 35, 4) // "list"

    },
    "SettingsWidget\0mutexWidgets\0\0mutex\0"
    "list"
};
...
void SettingsWidget::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        (void)_t;
        switch (_id) {
        case 0: _t->mutexWidgets((*reinterpret_cast< bool(*)>(_a[1])),(*reinterpret_cast< QStringList(*)>(_a[2]))); break;
        default: ;
        }
    }
}
