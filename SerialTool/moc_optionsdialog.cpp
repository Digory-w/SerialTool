...
#include <memory>
#include "src/settings/optionsdialog.h"
...
QT_MOC_LITERAL(3, 31, 14), // "processOptions"
QT_MOC_LITERAL(4, 46, 16), // "QAbstractButton*"
QT_MOC_LITERAL(5, 63, 6) // "button"

    },
    "OptionsDialog\0settingsUpdated\0\0"
    "processOptions\0QAbstractButton*\0button"
};
...
void OptionsDialog::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->processOptions((*reinterpret_cast< QAbstractButton*(*)>(_a[1]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&OptionsDialog::settingsUpdated)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void OptionsDialog::settingsUpdated()
{
