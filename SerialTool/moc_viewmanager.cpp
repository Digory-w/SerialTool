...
QT_MOC_LITERAL(1, 12, 12), // "transmitData"
QT_MOC_LITERAL(2, 25, 0), // ""
QT_MOC_LITERAL(3, 26, 15), // "dispatchMessage"
QT_MOC_LITERAL(4, 42, 8), // "receiver"
QT_MOC_LITERAL(5, 51, 7), // "message"
QT_MOC_LITERAL(6, 59, 8), // "saveFile"
QT_MOC_LITERAL(7, 68, 8) // "openFile"

    },
    "ViewManager\0transmitData\0\0dispatchMessage\0"
    "receiver\0message\0saveFile\0openFile"
};
...
void ViewManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->dispatchMessage((*reinterpret_cast< const QString(*)>(_a[1])),(*reinterpret_cast< const QByteArray(*)>(_a[2]))); break;
        ...
        {
            using _t = void (ViewManager::*)(const QByteArray & );
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&ViewManager::transmitData)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void ViewManager::transmitData(const QByteArray & _t1)
{
